...
|---|---|---|---|---|---|---|---|---|---|---|
| 003 | 2026-06-24 | SCO–BRA | PROP | Vinicius Jr anytime scorer | +110 | ~50–55% | +5–10% | 1.00u | Standard | Usage shift thesis: Rodrygo & Raphinha both out of WC; Vini is now sole focal point of Brazil attack. Got +110 vs quoted +125 (worse close). |
...
| Win / Loss / Push | 1 / 1 / 0 |
| Units staked | 3.50u |
| Units returned | 5.08u |
| Net P/L | +2.58u |
| ROI | +73.71% (settled only) |
| Bets beating close (CLV+) | TBD / 2 |
